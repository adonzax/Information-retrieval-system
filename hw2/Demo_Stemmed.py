# -*- coding: utf-8 -*-
"""
Quick demo: read a list of words from `in.0.50.txt`, stem each one, and look
up its df / ttf in the **stemmed** Cranfield index.  Output goes to
`Files/out.0.stop.stem.txt`.
"""
...
INDEX_DIR = os.path.join(HERE, "Files", "Stemmed")
...
def main():
    ...
    out_path = os.path.join(HERE, "Files", "out.0.stop.stem.txt")
