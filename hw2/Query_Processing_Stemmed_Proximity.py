# -*- coding: utf-8 -*-
"""
Stemmed counterpart of Query_Processing_Unstemmed_Proximity.py - reads
Cranfield queries, stems each non-stop term, fetches its inverted list
from the **stemmed** index and pickles termStats_Proximity / termVector_Proximity.
"""
