# -*- coding: utf-8 -*-
"""
Read each Cranfield query (`cranfield/cran.qry`), stem every term, look it
up in the **stemmed** index, and pickle the per-query (termVector, termStats)
objects that the retrieval models will consume.
"""
